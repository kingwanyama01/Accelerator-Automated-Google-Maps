package com.king.myautomatedlocation;
        ...
        fusedLocationClient.getLastLocation()
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        Toast.makeText(MapsActivity.this, "Fetched", Toast.LENGTH_SHORT).show();
                        ...
                        if (location != null) {
                            ...
                            Toast.makeText(MapsActivity.this, "Coodinates failed fetching", Toast.LENGTH_SHORT).show();
                            fetchGPS();
                        }
                    }
